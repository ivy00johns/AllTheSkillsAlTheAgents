...
name: no-headers
version: 1.0.0
description: Apply no-headers when testing the openclaw fallback path for skills whose body contains no double-hash section headers, verifying the entire body goes to AGENTS.md and SOUL.md becomes a placeholder.
---
